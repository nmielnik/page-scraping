...
BoxScore.parseBoxScore = function(html)
{
...
var StatTypes = [new StatInfo('Pts', true), new StatInfo('Tar', false, true), new StatInfo('Attempts'), new StatInfo('Completions'), new StatInfo('PassYds'), new StatInfo('PassTDs'),
             new StatInfo('PassINTs'), new StatInfo('RushAtt'), new StatInfo('RushYds'), new StatInfo('RushTDs'), new StatInfo('RecYds'), new StatInfo('RecTDs'),
             new StatInfo('Rec'), new StatInfo('TwoPt'), new StatInfo('FL'), new StatInfo('FG49'), new StatInfo('FG49Att', false, true), new StatInfo('FG49M', true),
             new StatInfo('FG50'), new StatInfo('FG50Att', false, true), new StatInfo('FG50M', true), new StatInfo('FG39'), new StatInfo('FG39Att', false, true),
             new StatInfo('FG39M', true), new StatInfo('FG', false, true), new StatInfo('FGAtt', false, true), new StatInfo('XP'), new StatInfo('XPAtt', false, true),
             new StatInfo('XPM', true), new StatInfo('DefTD'), new StatInfo('DefINT'), new StatInfo('DefFR'), new StatInfo('DefBlk'), new StatInfo('DefSfty'),
